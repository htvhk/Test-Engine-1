...
def main() -> None:
    if len(sys.argv) != 4:
        raise SystemExit(
            "usage: correction_history_gate_f_raw_signal_parity.py CONTROL CANDIDATE OUTPUT_JSON"
        )
    ...
    obj = {
        "schema": "TE1-ALPHA26-CORRECTION-HISTORY-GATE-F1-PARITY-v1",
        "status": "PASS",
        "depth": DEPTH,
        "positions": len(rows),
    ...
    print(
        "TE1_CORRECTION_HISTORY_GATE_F1_PARITY_PASS",
